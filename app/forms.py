...
class SettingsForm(FlaskForm):
    app_name = StringField('App Name', validators=[Optional()])
    interface_theme = RadioField('Interface Theme', choices=[('system', 'System preference'), ('light', 'Light'), ('dark', 'Dark')], validators=[DataRequired()])
